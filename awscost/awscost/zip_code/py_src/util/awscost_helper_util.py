...
AWS_ACCOUNTS = {
    'apps-prod': '584940039017',
    'apps-qa': '500681607159',
    'apps-stg': '103374647060',
    'aws-tools':  '484226015920',
    'bar':  '593295786737',  # build and release
    'cti':  '141602222194',
    'dea':  '182333787270',
    'delta-ml': '859700989387',
    # 'it':  '202350431037',  # No cti-poke
    'jump':  '268819736615',
    'mobile':  '610614477997',
    'mobile-dev': '177872632474',
    'net-eng':  '088414020449',
    'npi-audio': '940899004021',
    'pay-prod': '901521804309',
    'pay-qa': '861767417245',
    'pay-stg': '733620150503',
    'player-prod':  '146715042388',
    'player-stg':  '502465317373',
    'sr-dev': '638782101961',
    'sr-infra': '661796028321',
    'sr-prod': '886239521314',
    'sr-qa': '181133766305',
    # 'trust':  '018405429474', # No ctipoke
    'web': '911173767732',
    'web-shop': '865011437619'
}
# deprecated accounts
# 'sr-archive':  '664645359038',
# 'sr-stg':  '610352865374',
# 'sr-zoo':  '181352091498',
# 'sr-legacy':  '140819733876',
# Are these 2 accounts being retired?
# 'rpm-stg':  '191654292314',
# 'rpm-qa':  '822449686337'
# 'apps-stg-old':  '964954376716', # decommissioned.
...
def get_account_id_from_session(session):
    ...
    A session has the below format, need to grab it from the Arn.
    {u'AssumedRoleUser': {
       u'AssumedRoleId': 'AROAIS43WOXOT5UIP7QHE:ctipoke',
       u'Arn': 'arn:aws:sts::088414020449:assumed-role/ctipoke/ctipoke'
       },
    u'Credentials': {
       u'SecretAccessKey': 'OuQ0P...xYPVs',
       u'SessionToken': 'FQoGZXIvYXdzED0aDFX...R2NiQVJDa733Uo5JLZ4QU=',
...
def test_sort_nodes():
    ...
    print('\nTest node sort for RDS format mixed familes and database engines')
