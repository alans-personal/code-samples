...
def make_arn_from_type(env, region, arn, aws_type):
    ...
    Example arn:
    arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/sr-bl-Defau-EE942IZT8L2O/f5fb9158804750ff

    arn:aws:dynamodb:us-west-2:123456789012:table/BudServices
