"""Implements Apps_Flamegraph command by crobertson"""
...
class CmdApps_Flamegraph(CmdInterface):
    ...
    def get_cmd_properties(self):
        ...
        props = {
            'group': 'apps',
            'sub_commands': ['create'],
            'help_title': 'Create flamegraph files for docker service running in ECS cluster',
    ...
    def get_create_properties(self):
        ...
        props = {
            ...
            'help_examples': [
                '/bud apps_flamegraph create -e apps-qa -r us-east-1 -s authsvc',
                '/bud apps_flamegraph create -e apps-qa -r us-west-2 -s usersvc -t 40'
            ],
    ...
    def invoke_create(self, cmd_inputs):
        ...
        try:
            ...
            if status != 'Success' and status != 'Failed':
                ...
                dest_file_location = transfer_svg_file_to_s3_bucket(service, env, ssm_client, instance_id,
                                                                    invocation_response,
...
def get_service_discovery_table_name(session, region):
    ...
    return 'GlobalServiceDiscoveryTable'
...
def get_info_from_service_discovery_table(session, region,
    ...
    if count > 0:
        ...
        ret_val = {
            ...
            'externalHost': entry_to_use['externalHost'],
...
def test_cases_cmd_apps_flamegraph_main():
    """
