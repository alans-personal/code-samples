...
def text_command_response(title, text, color="#a0ffaa",
                          post=False, response_url='',
                          is_public=False, attachment=True):
    ...
    print('Inside beginning text_command_response with params title:{}, '
          ...
          'is_public:{}'.format(title, text, color, str(post),
                                response_url, str(is_public)))
...
##
# These are temporary to get build_kit up.
##
def test_build_kit_response(is_public=False, response_url=''):
    return build_kit_response.test_build_kit(is_public=is_public, response_url=response_url)


def test_build_kit_response2(is_public=False, response_url=''):
    return build_kit_response.test_build_kit2(is_public=is_public, response_url=response_url)


def test_build_kit_response3(is_public=False, response_url=''):
    return build_kit_response.test_build_kit3(is_public=is_public, response_url=response_url)


def test_build_kit_response_table(is_public=False, response_url=''):
    return build_kit_response.test_build_kit_table(is_public=is_public, response_url=response_url)
